...
import { Eye, EyeOff, Mail, Lock, ArrowRight, Package, User, Phone, MapPin, Building, CheckCircle } from "lucide-react";
...
export default function Register() {
  ...
  const handleSubmit = (e) => {
    ...
    toast.success("Account created successfully! Welcome to SENDAPARCEL 🎉");
  };
